...
const marytefirstName = 'Petras';
const maryteage = 87;
const maryteisMarries = false;

const jonasfirstName = 'Petras';
const jonasage = 66;
const jonasisMarries = false;

const onafirstName = 'Petras';
const onaage = 17;
const onaisMarries = true;
